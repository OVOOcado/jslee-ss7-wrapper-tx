...
public class TxArgsFactory implements ArgsFactory {
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createDialog(pl.ovoo.jslee
     * .ss7.wrapper.cap.ApplicationContextWrapper,
     * pl.ovoo.jslee.ss7.wrapper.common.args.SccpAddressWrapper,
     * pl.ovoo.jslee.ss7.wrapper.common.args.SccpAddressWrapper)
     */
    @Override
    public CapDialogWrapper createDialog(final ApplicationContextWrapper applicationContext,
            final SccpAddressWrapper srcSccpAddress, final SccpAddressWrapper destSccpAddress)
        ...
        try {
            ...
            case cap_v1_gsmSSF_to_gsmSCF_AC:
                ...
                CAPDialogCircuitSwitchedCall dialog = capProvider.getCAPServiceCircuitSwitchedCall().createNewDialog(
                        capApplicationContext, srcTxSccpAddress.getTxSccpAddress(),
                        destTxSccpAddress.getTxSccpAddress());
            ...
            case cap_v2_gsmSSF_to_gsmSCF_AC:
                ...
                dialog = capProvider.getCAPServiceCircuitSwitchedCall().createNewDialog(capApplicationContext,
                        srcTxSccpAddress.getTxSccpAddress(), destTxSccpAddress.getTxSccpAddress());
            ...
            case cap_v3_cap3_sms_AC:
                ...
                CAPDialogSms dialogSms = capProvider.getCAPServiceSms().createNewDialog(capApplicationContext,
                        srcTxSccpAddress.getTxSccpAddress(), destTxSccpAddress.getTxSccpAddress());
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createDialog(javax.slee.
    ...
    public CapDialogWrapper createRelayedDialog(CapDialogWrapper dialog, SccpAddressWrapper destAddress)
        ...
        CAPDialog capDialog = (CAPDialog) dialog.getActivityContextInterface().getActivity();
        CAPApplicationContext applicationContext = capDialog.getApplicationContext();

        TxCapDialogWrapperImpl txDialog = (TxCapDialogWrapperImpl) dialog;
        TxSccpAddressWrapperImpl srcTxAddress = (TxSccpAddressWrapperImpl) txDialog.getRemoteSccpAddress();
        TxSccpAddressWrapperImpl destTxAddress = (TxSccpAddressWrapperImpl) destAddress;
        Long dialogID = Long.parseLong(dialog.getDialogID());

        final TxCapDialogWrapperImpl txCapDialogWrapper;
        try {
            CAPDialogCircuitSwitchedCall relayedDialog = capProvider.getCAPServiceCircuitSwitchedCall()
                    .createNewRelayedDialog(applicationContext, srcTxAddress.getTxSccpAddress(),
                            destTxAddress.getTxSccpAddress(), dialogID);

            final CAPApplicationContext appCtx = relayedDialog.getApplicationContext();
            switch (appCtx) {
            case CapV1_gsmSSF_to_gsmSCF:
                txCapDialogWrapper = new TxCap1CallCapDialogWrapper(relayedDialog, capProvider);
                break;
            case CapV2_assistGsmSSF_to_gsmSCF:
            case CapV2_gsmSRF_to_gsmSCF:
            case CapV2_gsmSSF_to_gsmSCF:
                txCapDialogWrapper = new TxCap2CallCapDialogWrapper(relayedDialog, capProvider);
                break;
            default:
                txCapDialogWrapper = new TxCap3CallCapDialogWrapper(relayedDialog, capProvider);
                break;
            }
        } catch (CAPException e) {
            throw new Ss7WrapperException(e);
     ...
     * jslee.ss7.wrapper.cap.args.RPCauseValue)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createRequestReportSmsEventArg(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * SMSEventWrapper[])
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createSmsEvent(pl.ovoo.
     * jslee.ss7.wrapper.cap.args.EventTypeSMS,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.MonitorMode)
     */
    @Override
    public SMSEventWrapper createSmsEvent(final EventTypeSMS eventTypeSMS, final MonitorMode monitorMode) {
        final SMSEvent smsEvent = capProvider.getCAPParameterFactory().createSMSEvent(
                org.mobicents.protocols.ss7.cap.api.service.sms.primitive.EventTypeSMS
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCause(pl.ovoo.jslee.
     * ss7.wrapper.cap.args.CauseWrapper.CauseValue)
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createReleaseCallArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createReleaseSmsArg(pl.
     * ovoo.jslee.ss7.wrapper.cap.args.RPCauseWrapper)
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap1RequestReportBcsmEventArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createBcsmEvent(pl.ovoo.
     * jslee.ss7.wrapper.cap.args.EventTypeBCSM,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.MonitorMode,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.LegIDWrapper)
     */
    @Override
    public BCSMEventWrapper createBcsmEvent(final EventTypeBCSM eventTypeBCSM, final MonitorMode monitorMode,
            final LegIDWrapper legID) {
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap2BcsmEvent(pl.
     * ovoo.jslee.ss7.wrapper.cap.args.EventTypeBCSM,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.MonitorMode,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.LegIDWrapper,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.cap2.Cap2DPSpecificCriteriaWrapper)
     */
    @Override
    public Cap2BCSMEventWrapper createCap2BcsmEvent(final EventTypeBCSM eventTypeBCSM, final MonitorMode monitorMode,
            final LegIDWrapper legID, final Cap2DPSpecificCriteriaWrapper dpSpecificCriteria) {
     ...
     * @param legID
     *            the leg id
     * @param dpSpecificCriteria
     *            the dp specific criteria
     * @return the tx bcsm event
     */
    private BCSMEvent getTxBcsmEvent(final EventTypeBCSM eventTypeBCSM, final MonitorMode monitorMode,
            final LegIDWrapper legID, final Cap2DPSpecificCriteriaWrapper dpSpecificCriteria) {
        final org.mobicents.protocols.ss7.cap.api.primitives.EventTypeBCSM eventTypeBCSMTx = eventTypeBCSM != null
                ? org.mobicents.protocols.ss7.cap.api.primitives.EventTypeBCSM.getInstance(eventTypeBCSM.getValue())
                : null;
        final org.mobicents.protocols.ss7.cap.api.primitives.MonitorMode monitorModeTx = monitorMode != null
                ? org.mobicents.protocols.ss7.cap.api.primitives.MonitorMode.getInstance(monitorMode.getValue()) : null;
        final LegID legIDTx = legID != null ? ((TxLegIDWrapper) legID).getTxLegID() : null;
        final DpSpecificCriteria dpSpecificCriteriaTx = dpSpecificCriteria != null
                ? ((TxCap2DPSpecificCriteriaWrapper) dpSpecificCriteria).getTxDpSpecificCriteria() : null;

        return capProvider.getCAPParameterFactory().createBCSMEvent(eventTypeBCSMTx, monitorModeTx, legIDTx,
                dpSpecificCriteriaTx, false);
    }

    /*
     * (non-Javadoc)
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createLegId(boolean,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.LegType)
     */
    @Override
    public LegIDWrapper createLegId(final boolean isSendingSideID, final LegType legType) {
        final org.mobicents.protocols.ss7.inap.api.primitives.LegType legTypeTx = legType != null
                ? org.mobicents.protocols.ss7.inap.api.primitives.LegType.getInstance(legType.getValue()) : null;
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2DpSpecificCriteria(int)
     */
    @Override
    public Cap2DPSpecificCriteriaWrapper createCap2DpSpecificCriteria(final int applicationTimer) {
        final DpSpecificCriteria dpSpecificCriteria = capProvider.getCAPParameterFactory()
                .createDpSpecificCriteria(applicationTimer);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap2ConnectArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap1ConnectArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createRedirectionInformation(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * RedirectionInformationWrapper.Redirecting,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.RedirectionInformationWrapper.
     * OriginalReason,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.RedirectionInformationWrapper.
     * RedirectingReason, int)
     */
    @Override
    public RedirectionInformationWrapper createRedirectionInformation(
            final RedirectionInformationWrapper.Redirecting redirecting,
            final RedirectionInformationWrapper.OriginalReason originalReason,
            final RedirectionInformationWrapper.RedirectingReason redirectingReason, final int redirectionCounter)
            throws Ss7WrapperException {
        final RedirectionInformation redirectionInformation = capProvider.getISUPParameterFactory()
                .createRedirectionInformation();
        ...
        try {
            final RedirectionInformationInap redirectionInformationInap = capProvider.getINAPParameterFactory()
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCalledPartyNumber(pl
     * .ovoo.jslee.ss7.wrapper.cap.args.CalledPartyNumberWrapper.Nature,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.CalledPartyNumberWrapper.
     * RoutingToInternalNetworkNumber,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.CalledPartyNumberWrapper.
     * NumberingPlan, java.lang.String)
     */
    @Override
    public CalledPartyNumberWrapper createCalledPartyNumber(final CalledPartyNumberWrapper.Nature nature,
            ...
            final CalledPartyNumberWrapper.NumberingPlan numberingPlan, final String address)
            throws Ss7WrapperException {
        ...
        try {
            final CalledPartyNumberCap calledPartyNumberCap = capProvider.getCAPParameterFactory()
     ...
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCalledPartyNumber(pl
     * .ovoo.jslee.ss7.wrapper.cap.args.CalledPartyNumberWrapper)
     */
    @Override
    public CalledPartyNumberWrapper createCalledPartyNumber(final CalledPartyNumberWrapper calledPartyNumber)
            throws Ss7WrapperException {
        ...
        final CalledPartyNumberCap calledPartyNumberCap = capProvider.getCAPParameterFactory()
                .createCalledPartyNumberCap(data);
        return new TxCalledPartyNumberWrapper(calledPartyNumberCap);
    }
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCallingPartyNumberWrapper(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * CallingPartyNumberWrapper.Nature, boolean,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.CallingPartyNumberWrapper.
     * NumberingPlan,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.CallingPartyNumberWrapper.
     * Presentation,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.CallingPartyNumberWrapper.Screening,
     * java.lang.String)
     */
    @Override
    public CallingPartyNumberWrapper createCallingPartyNumberWrapper(final CallingPartyNumberWrapper.Nature nature,
            final boolean numberIncomplete, final CallingPartyNumberWrapper.NumberingPlan numberingPlan,
            final CallingPartyNumberWrapper.Presentation presentation,
            final CallingPartyNumberWrapper.Screening screening, final String address) throws Ss7WrapperException {
        final CallingPartyNumber callingPartyNumber = capProvider.getISUPParameterFactory().createCallingPartyNumber();
        callingPartyNumber.setNumberIncompleteIndicator(
                numberIncomplete ? CallingPartyNumber._NI_INCOMPLETE : CallingPartyNumber._NI_COMPLETE);
        if (nature != null) {
        ...
        try {
            return new TxCallingPartyNumberWrapper(
                    capProvider.getCAPParameterFactory().createCallingPartyNumberCap(callingPartyNumber));
        } catch (CAPException e) {
            throw new Ss7WrapperException(e);
        }
    }
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createOriginalCalledNumber
     * (pl.ovoo.jslee.ss7.wrapper.cap.args.OriginalCalledNumberWrapper.Nature,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.OriginalCalledNumberWrapper.
     * NumberingPlan,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.OriginalCalledNumberWrapper.
    ...
    public OriginalCalledNumberWrapper createOriginalCalledNumber(final OriginalCalledNumberWrapper.Nature nature,
            ...
            final OriginalCalledNumberWrapper.Presentation presentation, final String address)
            throws Ss7WrapperException {
        final OriginalCalledNumber originalCalledNumber = capProvider.getISUPParameterFactory()
        ...
        try {
            final OriginalCalledNumberCap originalCalledNumberCap = capProvider.getCAPParameterFactory()
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createRedirectingPartyNumber(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * RedirectingPartyNumberWrapper.Nature,
     ...
     */
    @Override
    public RedirectingPartyNumberWrapper createRedirectingPartyNumber(final RedirectingPartyNumberWrapper.Nature nature,
            final RedirectingPartyNumberWrapper.NumberingPlan numberingPlan,
            final RedirectingPartyNumberWrapper.Presentation presentation, final String address)
            throws Ss7WrapperException {
        ...
        try {
            final RedirectingPartyIDCap redirectingPartyIDCap = capProvider.getCAPParameterFactory()
                    .createRedirectingPartyIDCap(redirectingNumber);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCancelArgWrapper()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createApplyChargingArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap2ApplyChargingArg
     * ()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap3ApplyChargingArg
     * ()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2ReleaseIfDurationExceeded(boolean)
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2TimeDurationChargingWrapper(long, java.lang.Long,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.cap2.
     * Cap2ReleaseIfDurationExceededWrapper)
     */
    @Override
    public Cap2AChBillingChargingCharacteristicsWrapper.Cap2TimeDurationChargingWrapper createCap2TimeDurationChargingWrapper(
            final long maxCallPeriodDuration, final Long tariffSwitchInterval,
            final Cap2ReleaseIfDurationExceededWrapper cap2ReleaseIfDurationExceededWrapper) {
        return new TxCap2AChBillingChargingCharacteristicsWrapper.TxCap2TimeDurationChargingWrapper(
                maxCallPeriodDuration, tariffSwitchInterval, cap2ReleaseIfDurationExceededWrapper);
    }
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap3ReleaseIfDurationExceeded(boolean)
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap3TimeDurationChargingWrapper(long, java.lang.Long,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.cap3.
     * Cap3ReleaseIfDurationExceededWrapper)
     */
    @Override
    public Cap3AChBillingChargingCharacteristicsWrapper.Cap3TimeDurationChargingWrapper createCap3TimeDurationChargingWrapper(
            final long maxCallPeriodDuration, final Long tariffSwitchInterval,
            final Cap3ReleaseIfDurationExceededWrapper cap3ReleaseIfDurationExceededWrapper) {
        return new TxCap3AChBillingChargingCharacteristicsWrapper.TxCap3TimeDurationChargingWrapper(
                maxCallPeriodDuration, tariffSwitchInterval, cap3ReleaseIfDurationExceededWrapper);
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap3AChBillingChargingCharacteristics(pl.ovoo.jslee.ss7.wrapper.cap
     * .args.cap3.Cap3AChBillingChargingCharacteristicsWrapper.
     * Cap3TimeDurationChargingWrapper)
     */
    @Override
    public Cap3AChBillingChargingCharacteristicsWrapper createCap3AChBillingChargingCharacteristics(
            final Cap3AChBillingChargingCharacteristicsWrapper.Cap3TimeDurationChargingWrapper cap3TimeDurationChargingWrapper) {
        ...
        if (cap3TimeDurationChargingWrapper.getReleaseIfDurationExceeded() != null) {
            txCap3ReleaseIfDurationExceededWrapper = (TxCap3ReleaseIfDurationExceededWrapper) cap3TimeDurationChargingWrapper
                    .getReleaseIfDurationExceeded();
        } else {
            txCap3ReleaseIfDurationExceededWrapper = null;
        }
        final CAMELAChBillingChargingCharacteristics camelaChBillingChargingCharacteristics = capProvider
                .getCAPParameterFactory().createCAMELAChBillingChargingCharacteristics(
                        cap3TimeDurationChargingWrapper.getMaxCallPeriodDuration(),
                        cap3TimeDurationChargingWrapper.getReleaseIfDurationExceeded() != null,
                        cap3TimeDurationChargingWrapper.getTariffSwitchInterval(),
                        txCap3ReleaseIfDurationExceededWrapper != null
                                ? txCap3ReleaseIfDurationExceededWrapper.getTxAudibleIndicator() : null,
                        null, true);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createSendingSideId(pl.
     * ovoo.jslee.ss7.wrapper.cap.args.LegType)
     */
    @Override
    public SendingSideIDWrapper createSendingSideId(final LegType legType) {
        final SendingSideID sendingSideID = capProvider.getCAPParameterFactory().createSendingSideID(
                org.mobicents.protocols.ss7.inap.api.primitives.LegType.getInstance(legType.getValue()));
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2CallInformationRequestArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createEstablishTemporaryConnectionArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createPlayAnnouncementArg(
     * )
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createInformationToSend(pl
     * .ovoo.jslee.ss7.wrapper.cap.args.InbandInfoWrapper)
     */
    @Override
    public InformationToSendWrapper createInformationToSend(final InbandInfoWrapper inbandInfo) {
        final InformationToSend informationToSend = capProvider.getCAPParameterFactory()
                .createInformationToSend(((TxInbandInfoWrapper) inbandInfo).getTxInbandInfo());
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createInbandInfo(pl.ovoo.
     * jslee.ss7.wrapper.cap.args.MessageIDWrapper)
     */
    @Override
    public InbandInfoWrapper createInbandInfo(final MessageIDWrapper messageID) {
        ...
        final InbandInfo inbandInfo = capProvider.getCAPParameterFactory()
                .createInbandInfo(txMessageIDWrapper.getTxMessageID(), null, null, null);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createBearerCapability(pl.
     * ovoo.jslee.ss7.wrapper.cap.args.BearerCapWrapper)
     */
    @Override
    public BearerCapabilityWrapper createBearerCapability(final BearerCapWrapper bearerCapWrapper) {
        ...
        final BearerCapability bearerCapability = capProvider.getCAPParameterFactory()
                .createBearerCapability(txBearerCapWrapper.getTxBearerCap());
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createBearerCap(pl.ovoo.
     * jslee.ss7.wrapper.cap.args.ITU_TUserServiceInformationWrapper)
     */
    @Override
    public BearerCapWrapper createBearerCap(final ITU_TUserServiceInformationWrapper userServiceInformationWrapper)
            throws Ss7WrapperException {
        ...
        try {
            final BearerCap bearerCap = capProvider.getCAPParameterFactory()
                    .createBearerCap(txITU_tUserServiceInformationWrapper1.getTxUserServiceInformation());
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createLayer1Capability(pl.
     * ovoo.jslee.ss7.wrapper.cap.args.ITU_TUserServiceInformationWrapper.
     * Layer1CapabilityWrapper.Layer1Protocol)
     */
    @Override
    public ITU_TUserServiceInformationWrapper.Layer1CapabilityWrapper createLayer1Capability(
            final ITU_TUserServiceInformationWrapper.Layer1CapabilityWrapper.Layer1Protocol layer1Protocol) {
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createItuTUserServiceInformation(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * ITU_TUserServiceInformationWrapper.TransferCapability,
     ...
     */
    @Override
    public ITU_TUserServiceInformationWrapper createItuTUserServiceInformation(
            final ITU_TUserServiceInformationWrapper.TransferCapability transferCapability,
        ...
        final UserServiceInformation userServiceInformation = capProvider.getISUPParameterFactory()
                .createUserServiceInformation();
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createTimeAndTimezone(int,
     * int, int, int, int, int, int)
     */
    @Override
    public TimeAndTimezoneWrapper createTimeAndTimezone(final int year, final int month, final int day, final int hour,
            final int minute, final int second, final int timeZone) {
        final TimeAndTimezone timeAndTimezone = capProvider.getCAPParameterFactory().createTimeAndTimezone(year, month,
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createHighLayerCompatibility(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * HighLayerCompatibilityWrapper.Characteristics,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.HighLayerCompatibilityWrapper.
     * CodingStandard,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.HighLayerCompatibilityWrapper.
     * Interpretation,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.HighLayerCompatibilityWrapper.
     ...
     */
    @Override
    public HighLayerCompatibilityWrapper createHighLayerCompatibility(
            final HighLayerCompatibilityWrapper.Characteristics characteristics,
        ...
        final UserTeleserviceInformation userTeleserviceInformation = capProvider.getISUPParameterFactory()
                .createUserTeleserviceInformation();
        ...
        try {
            final HighLayerCompatibilityInap highLayerCompatibilityInap = capProvider.getINAPParameterFactory()
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap1InitialDpArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap2InitialDpArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap3InitialDpArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap3InitialDpSMSArg(
     * )
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCallReferenceNumber(
     * byte[])
     */
    @Override
    public CallReferenceNumberWrapper createCallReferenceNumber(final byte[] callReferenceNumber) {
        final CallReferenceNumber callReferenceNumber1 = capProvider.getMAPParameterFactory()
                .createCallReferenceNumber(callReferenceNumber);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCalledPartyBcdNumber
     * (pl.ovoo.jslee.ss7.wrapper.cap.args.CalledPartyBCDNumberWrapper.
     * NumberType,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.CalledPartyBCDNumberWrapper.
     * NumberingPlan, java.lang.String)
     */
    @Override
    public CalledPartyBCDNumberWrapper createCalledPartyBcdNumber(
            final CalledPartyBCDNumberWrapper.NumberType numberType,
            final CalledPartyBCDNumberWrapper.NumberingPlan numberingPlan, final String address)
            throws Ss7WrapperException {
        ...
        try {
            final CalledPartyBCDNumber calledPartyBCDNumber = capProvider.getCAPParameterFactory()
                    .createCalledPartyBCDNumber(addressNature, numberingPlanTx, address);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createEventReportSMSArg(pl
     * .ovoo.jslee.ss7.wrapper.cap.args.EventTypeSMS,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.EventSpecificInformationSMSWrapper)
     */
    @Override
    public EventReportSMSArgWrapper createEventReportSMSArg(EventTypeSMS smsEvent,
            EventSpecificInformationSMSWrapper eventSpecificInformationSMS) {
        TxEventReportSMSArgWrapperImpl erSMS = new TxEventReportSMSArgWrapperImpl();
        if (eventSpecificInformationSMS != null) {
            erSMS.setTxEventSpecificInformationBCSM(((TxEventSpecificInformationSMSWrapper) eventSpecificInformationSMS)
                    .getEventSpecificInformationSMS());
        }
        erSMS.setTxEventTypeSMS(org.mobicents.protocols.ss7.cap.api.service.sms.primitive.EventTypeSMS
                .getInstance(smsEvent.getValue()));
        return erSMS;
    }
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createReceivingSideID(pl.
     * ovoo.jslee.ss7.wrapper.cap.args.LegType)
     */
    @Override
    public ReceivingSideIDWrapper createReceivingSideID(final LegType legType) {
        final org.mobicents.protocols.ss7.inap.api.primitives.LegType legTypeTx = org.mobicents.protocols.ss7.inap.api.primitives.LegType
                .getInstance(legType.getValue());
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createMiscCallInfo(pl.ovoo
     * .jslee.ss7.wrapper.cap.args.MiscCallInfoWrapper.MessageType)
     */
    @Override
    public MiscCallInfoWrapper createMiscCallInfo(final MiscCallInfoWrapper.MessageType messageType) {
        final MiscCallInfoMessageType miscCallInfoMessageType = MiscCallInfoMessageType
                .getInstance(messageType.getValue());
        final MiscCallInfo miscCallInfo = capProvider.getINAPParameterFactory()
                .createMiscCallInfo(miscCallInfoMessageType, null);
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createEventSpecificInformationBCSM(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * EventSpecificInformationBCSMWrapper.TCalledPartyBusySpecificInfoWrapper)
     */
    @Override
    public EventSpecificInformationBCSMWrapper createEventSpecificInformationBCSM(
        ...
        final TxEventSpecificInformationBCSMWrapper.TxTCalledPartyBusySpecificInfoWrapper txTCalledPartyBusySpecificInfoWrapper = (TxEventSpecificInformationBCSMWrapper.TxTCalledPartyBusySpecificInfoWrapper) tCalledPartyBusySpecificInfoWrapper;
        final EventSpecificInformationBCSM eventSpecificInformationBCSM = capProvider.getCAPParameterFactory()
                .createEventSpecificInformationBCSM(
                        txTCalledPartyBusySpecificInfoWrapper.getTxTCalledPartyBusySpecificInfo());
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createEventSpecificInformationSMSSubmittedWrapper()
     */
    @Override
    public EventSpecificInformationSMSWrapper createEventSpecificInformationSMSSubmittedWrapper()
            throws Ss7WrapperException {
        OSmsSubmissionSpecificInfo oSmsSubmissionSpecificInfo = capProvider.getCAPParameterFactory()
                .createOSmsSubmissionSpecificInfo();
        EventSpecificInformationSMS eventSpecificInformationSMS = capProvider.getCAPParameterFactory()
                .createEventSpecificInformationSMSImpl(oSmsSubmissionSpecificInfo);
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createEventSpecificInformationSMSFailureWrapper(pl.ovoo.jslee.ss7.wrapper
     * .cap.args.SMSCauseWrapper.FailureCause)
     */
    @Override
    public EventSpecificInformationSMSWrapper createEventSpecificInformationSMSFailureWrapper(
            SMSCauseWrapper.FailureCause failureCause) throws Ss7WrapperException {
        MOSMSCause cause = MOSMSCause.getInstance(failureCause.getValue());
        OSmsFailureSpecificInfo oSmsFailureSpecificInfo = capProvider.getCAPParameterFactory()
                .createOSmsFailureSpecificInfo(cause);
        EventSpecificInformationSMS eventSpecificInformationSMS = capProvider.getCAPParameterFactory()
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createTCalledPartyBusySpecificInfoWrapper(pl.ovoo.jslee.ss7.wrapper.cap.
     * args.CauseWrapper)
     */
    @Override
    public EventSpecificInformationBCSMWrapper.TCalledPartyBusySpecificInfoWrapper createTCalledPartyBusySpecificInfoWrapper(
            final CauseWrapper causeWrapper) throws Ss7WrapperException {
        ...
        try {
            ...
            final TBusySpecificInfo tBusySpecificInfo = capProvider.getCAPParameterFactory()
                    .createTBusySpecificInfo(causeCap, false, false, null);
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2TCalledPartyBusySpecificInfoWrapper(pl.ovoo.jslee.ss7.wrapper.
     * cap.args.CauseWrapper, boolean)
     */
    @Override
    public Cap2EventSpecificInformationBCSMWrapper.Cap2TCalledPartyBusySpecificInfoWrapper createCap2TCalledPartyBusySpecificInfoWrapper(
            final CauseWrapper causeWrapper, final boolean callForwarded) throws Ss7WrapperException {
        final TxCauseWrapper txCauseWrapper = (TxCauseWrapper) causeWrapper;
        try {
            final CauseCap causeCap = capProvider.getCAPParameterFactory().createCauseCap(txCauseWrapper.getTxCause());
            final TBusySpecificInfo tBusySpecificInfo = capProvider.getCAPParameterFactory()
                    .createTBusySpecificInfo(causeCap, callForwarded, false, null);
            return new TxCap2EventSpecificInformationBCSMWrapper.TxCap2TCalledPartyBusySpecificInfoWrapper(
                    tBusySpecificInfo);
        } catch (CAPException e) {
            throw new Ss7WrapperException(e);
        }
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createAssistRequestInstructionsArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2AssistRequestInstructionsArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2IPSSPCapabilities(boolean, boolean, boolean, boolean, boolean)
     */
    @Override
    public Cap2IPSSPCapabilitiesWrapper createCap2IPSSPCapabilities(final boolean ipRoutingAddressSupported,
            final boolean voiceBackSupported, final boolean voiceInformationSupportedViaSpeechRecognition,
            final boolean voiceInformationSupportedViaVoiceRecognition,
            final boolean generationOfVoiceAnnouncementsFromTextSupported) {
        final IPSSPCapabilities ipsspCapabilities = capProvider.getCAPParameterFactory().createIPSSPCapabilities(
                ipRoutingAddressSupported, voiceBackSupported, voiceInformationSupportedViaSpeechRecognition,
                voiceInformationSupportedViaVoiceRecognition, generationOfVoiceAnnouncementsFromTextSupported, null);
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createSpecializedResourceReportArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2ApplyChargingReportArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2TimeDurationChargingResult(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * ReceivingSideIDWrapper,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.cap2.Cap2TimeInformationWrapper,
     * boolean)
     */
    @Override
    public Cap2TimeDurationChargingResultWrapper createCap2TimeDurationChargingResult(
            final ReceivingSideIDWrapper partyToCharge, final Cap2TimeInformationWrapper timeInformation,
        ...
        final TimeDurationChargingResult timeDurationChargingResult = capProvider.getCAPParameterFactory()
                .createTimeDurationChargingResult(partyToChargeTx, timeInformationTx, false, callActive, null, null);
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap3TimeDurationChargingResult(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * ReceivingSideIDWrapper,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.cap3.Cap3TimeInformationWrapper,
     * boolean)
     */
    @Override
    public Cap3TimeDurationChargingResultWrapper createCap3TimeDurationChargingResult(
            final ReceivingSideIDWrapper partyToCharge, final Cap3TimeInformationWrapper timeInformation,
            final boolean callActive) {
        final ReceivingSideID partyToChargeTx;
        if (partyToCharge == null) {
            partyToChargeTx = null;
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap2TimeInformation(
     * int)
     */
    @Override
    public Cap2TimeInformationWrapper createCap2TimeInformation(final int timeIfNoTariffSwitch) {
        final TimeInformation timeInformation = capProvider.getCAPParameterFactory()
                .createTimeInformation(timeIfNoTariffSwitch);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createCap3TimeInformation(
     * int)
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2CallInformationReportArg()
     */
    @Override
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createRequestedInformation
     * (pl.ovoo.jslee.ss7.wrapper.cap.args.RequestedInformationValueWrapper)
     */
    @Override
    public RequestedInformationWrapper createRequestedInformation(
            final RequestedInformationValueWrapper requestedInformationValueWrapper) {
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createRequestedInformationValueReleaseCause(pl.ovoo.jslee.ss7.wrapper.cap
     * .args.CauseWrapper)
     */
    @Override
    public RequestedInformationValueWrapper createRequestedInformationValueReleaseCause(final CauseWrapper cause)
            throws Ss7WrapperException {
        final TxCauseWrapper txCauseWrapper = (TxCauseWrapper) cause;
        try {
            final CauseCap causeCap = capProvider.getCAPParameterFactory().createCauseCap(txCauseWrapper.getTxCause());
            final RequestedInformation requestedInformation = capProvider.getCAPParameterFactory()
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createRequestedInformationValueCallConnectedElapsedTime(int)
     */
    @Override
    public RequestedInformationValueWrapper createRequestedInformationValueCallConnectedElapsedTime(
            final int callConnectedElapsedTime) throws Ss7WrapperException {
        final RequestedInformation requestedInformation = capProvider.getCAPParameterFactory()
                .createRequestedInformation_CallConnectedElapsedTime(callConnectedElapsedTime);
        return new TxRequestedInformationValueWrapper(requestedInformation);
    }
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2AChBillingChargingCharacteristics(pl.ovoo.jslee.ss7.wrapper.cap
     * .args.cap2.Cap2AChBillingChargingCharacteristicsWrapper.
     * Cap2TimeDurationChargingWrapper)
     */
    @Override
    public Cap2AChBillingChargingCharacteristicsWrapper createCap2AChBillingChargingCharacteristics(
        ...
        if (cap2TimeDurationChargingWrapper.getReleaseIfDurationExceeded() != null) {
            txCap2ReleaseIfDurationExceededWrapper = (TxCap2ReleaseIfDurationExceededWrapper) cap2TimeDurationChargingWrapper
                    .getReleaseIfDurationExceeded();
        } else {
        ...
        final CAMELAChBillingChargingCharacteristics camelaChBillingChargingCharacteristics = capProvider
                .getCAPParameterFactory().createCAMELAChBillingChargingCharacteristics(
                        cap2TimeDurationChargingWrapper.getMaxCallPeriodDuration(),
                        cap2TimeDurationChargingWrapper.getReleaseIfDurationExceeded() != null,
                        cap2TimeDurationChargingWrapper.getTariffSwitchInterval(),
                        txCap2ReleaseIfDurationExceededWrapper != null
                                ? txCap2ReleaseIfDurationExceededWrapper.getTxAudibleIndicator() : null,
                        null, false);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createSMSAddressString(pl.
     * ovoo.jslee.ss7.wrapper.common.args.AddressStringWrapper.Nature,
     * pl.ovoo.jslee.ss7.wrapper.common.args.AddressStringWrapper.NumberingPlan,
     * java.lang.String)
     */
    @Override
    public AddressStringWrapper createSMSAddressString(AddressStringWrapper.Nature nature,
            AddressStringWrapper.NumberingPlan numberingPlan, String address) {
        final AddressNature addressNature;
        if (nature == null) {
            addressNature = null;
        } else {
        ...
        final SMSAddressString sMSAddressString = capProvider.getCAPParameterFactory()
                .createSMSAddressString(addressNature, numberingPlanTx, address);
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createFurnishChargingInformationArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2FurnishChargingInformationArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap3FurnishChargingInformationArg()
     */
    @Override
     ...
     * 
     * @see pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#
     * createCap2FCIBCCCAMELsequence1(pl.ovoo.jslee.ss7.wrapper.cap.args.
     * FreeFormatDataWrapper,
     * pl.ovoo.jslee.ss7.wrapper.cap.args.SendingSideIDWrapper)
     */
    @Override
    public Cap2FCIBCCCAMELsequence1Wrapper createCap2FCIBCCCAMELsequence1(final FreeFormatDataWrapper freeFormatData,
            final SendingSideIDWrapper partyToCharge) {
        ...
        final FCIBCCCAMELsequence1 fcibcccameLsequence1 = capProvider.getCAPParameterFactory()
                .createFCIBCCCAMELsequence1(txFreeFormatData, txPartyToCharge, null);
     ...
     * 
     * @see
     * pl.ovoo.jslee.ss7.wrapper.cap.args.ArgsFactory#createFreeFormatData(byte[
     * ])
     */
    @Override
